...
const widgetMappings = {
  ...
  openweathermap: dynamic(
    () => import("components/widgets/openweathermap/weather"),
  ),
  ...
  unifi_console: dynamic(
    () => import("components/widgets/unifi_console/unifi_console"),
  ),
  ...
  user: dynamic(() => import("components/widgets/user/user")),
};
